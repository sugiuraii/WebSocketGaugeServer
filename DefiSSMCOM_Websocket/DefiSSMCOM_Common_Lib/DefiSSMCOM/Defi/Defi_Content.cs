...
namespace DefiSSMCOM
{
    public class DefiContentTable : ContentTableCommon<DefiParameterCode, DefiNumericContent>
    {
        ...
        protected override void set_numeric_content_table()
        {
            ...
            _numeric_content_table.Add(DefiParameterCode.Oil_Pres, new DefiNumericContent(0x03, x=>4.23e-3*x + 0.0, "kgf/cm2")); //以下実物合わせしていないので、変換係数は適当
            _numeric_content_table.Add(DefiParameterCode.Fuel_Pres, new DefiNumericContent(0x04, x=>2.54e-3*x + 0.0, "kgf/cm2"));
            _numeric_content_table.Add(DefiParameterCode.Ext_Temp, new DefiNumericContent(0x05, x=>3.81e-1*x + 200.0, "C"));
            _numeric_content_table.Add(DefiParameterCode.Oil_Temp, new DefiNumericContent(0x07, x=>4.23e-2*x + 50.0, "C"));
            _numeric_content_table.Add(DefiParameterCode.Water_Temp, new DefiNumericContent(0x0f, x=>4.23e-2*x + 20.0, "C"));
        }
    }
